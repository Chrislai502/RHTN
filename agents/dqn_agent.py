...
class DQNAgent(object):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n, i, network_now, network_next):
        log = {}
        if (self.t > self.learning_starts
            ...
            log = self.critic.update(
                ob_no, ac_na, next_ob_no, re_n, terminal_n, i, network_now, network_next
            )

            # TODO update the target network periodically 
            # HINT: your critic already has this functionality implemented
            
            #RHTN no need to update target networks
