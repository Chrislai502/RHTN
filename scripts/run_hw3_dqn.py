...
def main():
    ...
    parser.add_argument(
        '--env_name',
        default='MsPacman-v0',
        choices=('CartPole-v0', 'PongNoFrameskip-v4', 'LunarLander-v3', 'MsPacman-v0')
    )
    ...
    parser.add_argument('--num_networks', type = int, default = int(10))
    parser.add_argument('--warm_start_iter', type = int, default = int(50000))
    parser.add_argument('--increment_steps', type = int, default = int(10))
